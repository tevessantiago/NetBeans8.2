...
public class FileText implements I_File{
    ...
    @Override public void addLine(String linea) {
        //appendText(linea+"\n");
    ...
    @Override public void setLines(Collection<String> lineas) {
        try (BufferedWriter out=new BufferedWriter(new FileWriter(file))){
            for(String s:lineas) out.write(s+"\n");
        }catch(IOException e)           {System.out.println("Problemas al leer el archivo "+file); }
    }
    @Override public void addLines(Collection<String> lineas) {
        try (BufferedWriter out=new BufferedWriter(new FileWriter(file,true))){
            for(String s:lineas) out.write(s+"\n");
        }catch(IOException e)           {System.out.println("Problemas al leer el archivo "+file); }
    }
    ...
    @Override public void remove(String line) {
